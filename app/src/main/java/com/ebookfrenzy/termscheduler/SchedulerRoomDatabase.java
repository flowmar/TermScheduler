 ...
 *******************/
@Database(
    entities = {Term.class, Course.class, Assessment.class},
    version = 1)
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
          ...
          executor.execute(
              () -> {
                ...
                termDao.insertTerm(new Term("Spring 2022", "2022-01-01", "2022-05-31"));
                ...
                courseDao.insertCourse(
                    new Course(
                        ...
                        "Emily Planners",
                        "(653)352-5234",
                        "eplanners@school" + ".edu",
                        "Assessments were very difficult",
                        "Spring 2022",
                        2,
                        null,
                        null));
