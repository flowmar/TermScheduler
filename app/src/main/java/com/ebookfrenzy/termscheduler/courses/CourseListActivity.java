...
public class CourseListActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    new ItemTouchHelper(
            new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
              ...
              public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                mCourseViewModel.delete(getApplicationContext(), course);
    ...
    courseAdapter.setOnItemClickListener(
        course -> {
          Intent intent = new Intent(CourseListActivity.this, AddEditCourseActivity.class);
          intent.putExtra(AddEditCourseActivity.EXTRA_COURSE_ID, course.getId());
          intent.putExtra(AddEditCourseActivity.EXTRA_COURSE_NAME, course.getCourseName());
          intent.putExtra(AddEditCourseActivity.EXTRA_COURSE_START_DATE, course.getStartDate());
          intent.putExtra(AddEditCourseActivity.EXTRA_COURSE_END_DATE, course.getEndDate());
          intent.putExtra(
              AddEditCourseActivity.EXTRA_COURSE_INSTRUCTOR_NAME, course.getInstructorName());
          intent.putExtra(
              AddEditCourseActivity.EXTRA_COURSE_INSTRUCTOR_EMAIL, course.getInstructorEmail());
          intent.putExtra(
              AddEditCourseActivity.EXTRA_COURSE_INSTRUCTOR_PHONE,
              course.getInstructorPhoneNumber());
          intent.putExtra(AddEditCourseActivity.EXTRA_COURSE_STATUS, course.getStatus());
          intent.putExtra(AddEditCourseActivity.EXTRA_COURSE_TERM_ID, course.getTermId());
          intent.putExtra(AddEditCourseActivity.EXTRA_COURSE_TERM_NAME, course.getTermName());
          intent.putExtra(AddEditCourseActivity.EXTRA_COURSE_NOTE, course.getCourseNote());
          ...
          intent.putExtra(
              AddEditCourseActivity.EXTRA_COURSE_END_ALARM_DATETIME,
